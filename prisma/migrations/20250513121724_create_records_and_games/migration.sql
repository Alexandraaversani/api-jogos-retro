/*
  ...
  - Added the required column `nikename` to the `users` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "users_nikename_key" ON "users"("nikename");
